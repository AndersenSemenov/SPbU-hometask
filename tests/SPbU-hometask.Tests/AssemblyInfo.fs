...
[<assembly: AssemblyTitleAttribute("SPbU-hometask.Tests")>]
[<assembly: AssemblyProductAttribute("SPbU-hometask")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "SPbU-hometask.Tests"
    let [<Literal>] AssemblyProduct = "SPbU-hometask"
